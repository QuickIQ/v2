...
const personalityTypes = [
  // IN group (Row 1)
  { type: 'INTJ', icon: '🧠', nickname: 'Architect' },
  { type: 'INTP', icon: '💭', nickname: 'Logician' },
  { type: 'INFJ', icon: '🌙', nickname: 'Advocate' },
  { type: 'INFP', icon: '🌸', nickname: 'Mediator' },
  // EN group (Row 2)
  { type: 'ENTJ', icon: '⚔️', nickname: 'Commander' },
  { type: 'ENTP', icon: '⚡', nickname: 'Debater' },
  { type: 'ENFJ', icon: '🌻', nickname: 'Protagonist' },
  { type: 'ENFP', icon: '🔥', nickname: 'Campaigner' },
  // IS group (Row 3)
  { type: 'ISTJ', icon: '📘', nickname: 'Logistician' },
  { type: 'ISFJ', icon: '🌿', nickname: 'Defender' },
  { type: 'ISTP', icon: '🛠️', nickname: 'Virtuoso' },
  { type: 'ISFP', icon: '🎨', nickname: 'Adventurer' },
  // ES group (Row 4)
  { type: 'ESTJ', icon: '🧩', nickname: 'Executive' },
  { type: 'ESFJ', icon: '🤝', nickname: 'Consul' },
  { type: 'ESTP', icon: '🚀', nickname: 'Entrepreneur' },
  { type: 'ESFP', icon: '💃', nickname: 'Entertainer' },
];
