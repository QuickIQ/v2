...
import { useNegotiationSkillsTestStore, NegotiationSkillsQuestion, NegotiationSkillsAnswer } from '../../../store/negotiationSkillsTestStore';
import { useMobile } from '../../../hooks/useMobile';
import { Clock, UsersRound } from 'lucide-react';
import '../../../App.css';

interface Props {
  questions: NegotiationSkillsQuestion[];
  onComplete: () => void;
}
...
function NegotiationSkillsQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useNegotiationSkillsTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useNegotiationSkillsTestStore.getState().timeRemaining;
  ...
  const handleOptionSelect = (optionIndex: number) => {
    ...
    const answer: NegotiationSkillsAnswer = {
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.negotiationSkills.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default NegotiationSkillsQuestionsPage;
