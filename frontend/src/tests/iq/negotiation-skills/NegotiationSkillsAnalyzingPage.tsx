...
function NegotiationSkillsAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.negotiationSkills.calculating.title', 'Analyzing your negotiation style and approach...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.negotiationSkills.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
...
export default NegotiationSkillsAnalyzingPage;
