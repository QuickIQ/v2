...
export const resultContent: Record<'excellent' | 'good' | 'developing', ProblemSolvingResult> = {
  excellent: {
    level: 'excellent',
    title: '', // Will be filled via localization: tests.problemSolving.result.excellent.title
    summary: '', // Will be filled via localization: tests.problemSolving.result.excellent.summary
    insights: [], // Will be filled via localization: tests.problemSolving.result.excellent.insights
    sections: {
      strengths: '', // Will be filled via localization: tests.problemSolving.result.excellent.strengths.text
      growthAreas: '', // Will be filled via localization: tests.problemSolving.result.excellent.growthAreas.text
      practicalApplications: '', // Will be filled via localization: tests.problemSolving.result.excellent.practicalApplications.text
      futurePotential: '', // Will be filled via localization: tests.problemSolving.result.excellent.futurePotential.text
    }
  },
  good: {
    level: 'good',
