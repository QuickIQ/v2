...
function AttentionSpanAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.attentionSpan.calculating.title', 'Analyzing your attention span and focus patterns...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.attentionSpan.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Uzun süre odaklanmakta zorlanıyor musunuz?'
                      : 'Do you struggle to maintain focus for long periods?')
                  : (i18n.language === 'tr'
                      ? 'Dikkatiniz kolayca dağılıyor mu?'
...
export default AttentionSpanAnalyzingPage;
