...
interface AttentionSpanUnlockTemplateProps {
  level: 'excellent' | 'good' | 'developing';
  locale?: 'en' | 'tr';
}

export default function AttentionSpanUnlockTemplate({ level, locale }: AttentionSpanUnlockTemplateProps) {
  ...
  const getContent = () => {
    const baseKey = `tests.attentionSpan.result.${level}`;
    return {
  ...
  const sections = [
    {
      ...
      title: currentLocale === 'tr' ? 'Odaklanma Profiliniz' : 'Your Attention Span Profile',
    ...
    },
    {
      ...
      text: currentLocale === 'tr' 
        ? 'Odaklanma süreniz ve dikkat kalıplarınız hakkında en önemli bulgular:'
        : 'The most important findings about your attention span and focus patterns:',
    ...
    },
    {
      ...
      text: content.sections?.strengths || (level === 'excellent'
        ? (currentLocale === 'tr' 
          ? 'Odaklanma konusunda olağanüstü yeteneklere sahipsiniz. İşte en güçlü yönleriniz:'
          : 'You possess exceptional attention span abilities. Here are your strongest areas:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Odaklanma konusunda güçlü yetenekleriniz var. İşte öne çıkan güçlü yönleriniz:'
          : 'You have strong attention span skills. Here are your standout strengths:')
        : (currentLocale === 'tr'
          ? 'Odaklanma potansiyeliniz gelişiyor. İşte güçlü yönleriniz:'
          : 'Your attention span potential is developing. Here are your strengths:')),
    },
    {
      key: 'growth',
      ...
      text: content.sections?.growthAreas || (level === 'excellent'
        ? (currentLocale === 'tr'
          ? 'Mükemmel seviyede olsanız bile, odaklanmanızı daha da geliştirebileceğiniz alanlar:'
          : 'Even at an excellent level, areas where you can further enhance your attention span:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Odaklanmanızı daha da artırmak için odaklanabileceğiniz alanlar:'
          : 'Areas you can focus on to further increase your attention span:')
        : (currentLocale === 'tr'
          ? 'Odaklanmanızı geliştirmek için pratik yapabileceğiniz alanlar:'
          : 'Areas you can practice to develop your attention span abilities:')),
    },
    {
      key: 'application',
      ...
      text: content.sections?.practicalApplications || (currentLocale === 'tr'
        ? 'Odaklanmanızı günlük hayatta nasıl koruyabileceğiniz:'
        : 'How you can maintain your attention span in daily life:'),
    },
    {
      key: 'future',
      ...
      text: content.sections?.futurePotential || (currentLocale === 'tr'
        ? 'Odaklanmanızı geliştirmeye devam ederseniz neler başarabileceğiniz:'
        : 'What you can achieve if you continue developing your attention span:'),
    },
  ];
      ...
      <div style={{
        ...
        >
          ...
          <h1 style={{
            ...
            Your Detailed Attention Span Report
          </h1>
          <p style={{
