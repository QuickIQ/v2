...
import { useTimeManagementTestStore, TimeManagementQuestion, TimeManagementAnswer } from '../../../store/timeManagementTestStore';
...
function TimeManagementQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useTimeManagementTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useTimeManagementTestStore.getState().timeRemaining;
  ...
  const handleOptionSelect = (optionIndex: number) => {
    ...
    const answer: TimeManagementAnswer = {
  ...
  if (!currentQuestion) {
    return (
      <div style={{
        ...
        <div className="loading" style={{ fontSize: '18px', color: '#00CED1' }}>
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.timeManagement.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    background: !currentAnswer || autoAdvancing
                      ...
                      : 'linear-gradient(135deg, #00CED1 0%, #B0E0E6 100%)',
                    border: 'none',
                    borderRadius: '12px',
...
export default TimeManagementQuestionsPage;
