...
interface TimeManagementUnlockTemplateProps {
  level: 'excellent' | 'good' | 'developing';
  locale?: 'en' | 'tr';
}

export default function TimeManagementUnlockTemplate({ level, locale }: TimeManagementUnlockTemplateProps) {
  ...
  const getContent = () => {
    const baseKey = `tests.timeManagement.result.${level}`;
    return {
  ...
  const sections = [
    {
      ...
      title: currentLocale === 'tr' ? 'Zaman Yönetimi Profiliniz' : 'Your Time Management Profile',
      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <motion.div
              ...
              transition={{ 
                ...
                filter: 'drop-shadow(0 2px 8px rgba(0, 206, 209, 0.4))',
                }}
              >
              ⏰
            </motion.div>
          ...
          <h1 style={{
            ...
            Your Detailed Time Management Report
          </h1>
          <p style={{
