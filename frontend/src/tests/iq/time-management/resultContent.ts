...
export const resultContent: Record<'excellent' | 'good' | 'developing', TimeManagementResult> = {
  excellent: {
    level: 'excellent',
    title: '', // Will be filled via localization: tests.timeManagement.result.excellent.title
    summary: '', // Will be filled via localization: tests.timeManagement.result.excellent.summary
    insights: [], // Will be filled via localization: tests.timeManagement.result.excellent.insights
    sections: {
      strengths: '', // Will be filled via localization: tests.timeManagement.result.excellent.strengths.text
      growthAreas: '', // Will be filled via localization: tests.timeManagement.result.excellent.growthAreas.text
      practicalApplications: '', // Will be filled via localization: tests.timeManagement.result.excellent.practicalApplications.text
      futurePotential: '', // Will be filled via localization: tests.timeManagement.result.excellent.futurePotential.text
    }
  },
  good: {
    level: 'good',
