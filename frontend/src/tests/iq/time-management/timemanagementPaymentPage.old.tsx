...
function RecentResults({ t, i18n, isMobile }: { t: any; i18n: any; isMobile: boolean }) {
  ...
  return (
    <section style={{
      ...
      >
        {getTranslation('tests.timeManagement.payment.recent_results', i18n.language === 'tr' ? 'Güncel Sonuçlar' : 'Recent Results')}
      </motion.h2>
      <div style={{
        maxWidth: '800px',
        margin: '0 auto',
...
export default function TimeManagementPaymentPage() {
  ...
  const { resultLevel, resultData } = useTimeManagementTestStore();
  ...
  const handleCardSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/test/time-management/unlock');
    } catch (error) {
      setProcessing(false);
  ...
  const getResultTitle = () => {
    ...
    if (resultLevel === 'excellent') return 'Time Master – The Efficient Organizer';
    if (resultLevel === 'good') return 'Time Manager – The Balanced Planner';
    return 'Time Learner – The Developing Organizer';
  };
  ...
  const getPlaceholderInsights = () => [
    'Task Prioritization: Discover how you organize and prioritize your daily tasks',
    'Time Planning: Learn effective strategies for scheduling and time-blocking',
    'Productivity Patterns: Explore your natural rhythms and peak performance times',
    'Efficiency Strategies: Practical steps to maximize your time and minimize waste',
    'Future Potential: Unlock your path to becoming a time management master',
    'Daily Habits: Build routines that support optimal time utilization'
  ];
    ...
    <main style={{
      ...
      <div style={{
        ...
        <motion.section
          ...
          style={{
            ...
            boxShadow: 'inset 0 0 30px rgba(255,255,255,0.05), 0 0 50px rgba(0,206,209,0.35)',
            overflow: 'hidden',
            cursor: 'default',
        ...
        >
          ...
          <motion.div
            animate={{
              background: [
                'linear-gradient(135deg, #00CED1 0%, #20B2AA 100%)',
                'linear-gradient(135deg, #00B8B8 0%, #1FA5A5 100%)',
                'linear-gradient(135deg, #00CED1 0%, #20B2AA 100%)',
              ],
            }}
            transition={{
          ...
          <div style={{
            ...
            >
              Unlock your time management potential — AI has analyzed your answers and crafted a detailed insight just for you.
            </motion.p>
          ...
          >
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                fontWeight: '700',
                background: 'linear-gradient(135deg, #00CED1 0%, #B0E0E6 50%, #00CED1 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
                margin: 0,
                marginBottom: '8px',
                textShadow: '0 2px 8px rgba(0, 206, 209, 0.3)',
              }}>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {getTranslation('tests.timeManagement.payment.locked_subtext', 'Your personalized insight is waiting — Discover your hidden strengths, creative growth zones, and unique thinking blueprint.')}
              </p>
              <motion.button
                onClick={() => {
                  const paymentSection = document.getElementById('payment-section');
              ...
              >
                🔓 {getTranslation('tests.timeManagement.payment.unlock_button', 'Unlock Detailed Result')}
              </motion.button>
            </motion.div>
          </motion.div>
        ) : null}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.timeManagement.payment.why_trust', i18n.language === 'tr' ? 'Neden QuickIQ\'ya Güvenmelisiniz?' : 'Why Trust QuickIQ?')}
          </h2>
          ...
          <div style={{
            ...
            {[
              {
                icon: <Shield size={32} />,
                title: getTranslation('tests.timeManagement.payment.trust_feature1_title', i18n.language === 'tr' ? 'Yapay Zeka Destekli Yaratıcılık Analizi' : 'AI-Powered Creativity Analysis'),
                desc: getTranslation('tests.timeManagement.payment.trust_feature1_desc', i18n.language === 'tr' ? 'Gelişmiş algoritmalarla yaratıcı düşünme tarzınızın derinlemesine analizi.' : 'Deep analysis of your creative thinking style with advanced algorithms.'),
              },
              {
                icon: <CheckCircle size={32} />,
                title: getTranslation('tests.timeManagement.payment.trust_feature2_title', i18n.language === 'tr' ? 'Uygulanabilir İçgörüler' : 'Actionable Insights'),
                desc: getTranslation('tests.timeManagement.payment.trust_feature2_desc', i18n.language === 'tr' ? 'Gerçek hayatta kullanabileceğiniz pratik tavsiyeler.' : 'Practical advice you can use in real life.'),
              },
              {
                icon: <Lock size={32} />,
                title: getTranslation('tests.timeManagement.payment.trust_feature3_title', i18n.language === 'tr' ? 'Kişiselleştirilmiş Gelişim Planı' : 'Personalized Growth Plan'),
                desc: getTranslation('tests.timeManagement.payment.trust_feature3_desc', i18n.language === 'tr' ? 'Size özel hazırlanmış kapsamlı gelişim stratejisi.' : 'Comprehensive growth strategy tailored just for you.'),
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.timeManagement.payment.reviews', i18n.language === 'tr' ? 'Yorumlar' : 'Reviews')}
          </h2>
          <p style={{
            ...
            {getTranslation('tests.timeManagement.payment.reviews_subtitle', i18n.language === 'tr' ? 'Mükemmel ⭐ 4.7 puan — 1769 yorum' : 'Excellent ⭐ 4.7 rating — 1769 reviews')}
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    <p style={{
                      ...
                      {getTranslation('tests.timeManagement.payment.verified_customer', i18n.language === 'tr' ? 'Doğrulanmış Müşteri' : 'Verified Customer')}
                    </p>
                    <p style={{
                      fontSize: '14px',
                      color: '#666',
      ...
      >
        <p style={{
          ...
          {getTranslation('tests.timeManagement.payment.footer', i18n.language === 'tr'
