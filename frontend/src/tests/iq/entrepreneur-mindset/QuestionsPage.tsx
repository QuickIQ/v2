...
import { useEntrepreneurMindsetTestStore, EntrepreneurMindsetQuestion, EntrepreneurMindsetAnswer } from '../../../store/entrepreneurMindsetTestStore';
...
function EntrepreneurMindsetQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useEntrepreneurMindsetTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useEntrepreneurMindsetTestStore.getState().timeRemaining;
  ...
  const handleOptionSelect = (optionIndex: number) => {
    ...
    const answer: EntrepreneurMindsetAnswer = {
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.entrepreneurMindset.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div style={{
      ...
      <div style={{
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    background: !currentAnswer || autoAdvancing
                      ...
                      : 'linear-gradient(135deg, #4A6CFF 0%, #FFD700 100%)',
                    border: 'none',
                    borderRadius: '12px',
        ...
        {/* Header: Creativity Test + Question Progress + Timer - Below the card - Fixed, no animation */}
        <div
          style={{
            width: '100%',
            padding: isMobile ? '16px 20px' : '20px 24px',
...
export default EntrepreneurMindsetQuestionsPage;
