...
export default function EntrepreneurMindsetPaymentPage() {
  ...
  const { resultLevel, resultData } = useEntrepreneurMindsetTestStore();
  ...
  const handleCardSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/test/entrepreneur-mindset/unlock');
    } catch (error) {
      setProcessing(false);
  ...
  const getResultTitle = () => {
    ...
    if (resultLevel === 'excellent') return 'Entrepreneur Mindset – The Visionary Leader';
    if (resultLevel === 'good') return 'Entrepreneur Mindset – The Strategic Innovator';
    return 'Entrepreneur Mindset – The Emerging Entrepreneur';
  };
  ...
  const getPlaceholderInsights = () => [
    'Opportunity Recognition: Discover how you identify and evaluate business opportunities',
    'Risk Assessment: Learn to balance calculated risks with potential rewards',
    'Innovation Patterns: Explore your approach to creating new solutions',
    'Growth Strategies: Practical steps to develop your entrepreneurial skills',
    'Future Potential: Unlock your path to business success and leadership',
    'Network Building: Build relationships that support your entrepreneurial journey'
  ];
