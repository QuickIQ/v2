export interface EntrepreneurMindsetResult {
...
export const resultContent: Record<'excellent' | 'good' | 'developing', EntrepreneurMindsetResult> = {
  excellent: {
    level: 'excellent',
    title: '', // Will be filled via localization: tests.entrepreneurMindset.result.excellent.title
