...
import { useAmbitionTestStore, AmbitionQuestion, AmbitionAnswer } from '../../../store/ambitionTestStore';
import { useMobile } from '../../../hooks/useMobile';
import { Clock, TrendingUp } from 'lucide-react';
import '../../../App.css';

interface Props {
  questions: AmbitionQuestion[];
  onComplete: () => void;
}
...
function AmbitionQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useAmbitionTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useAmbitionTestStore.getState().timeRemaining;
  ...
  if (!currentQuestion) {
    return (
      <div style={{
        ...
        <div className="loading" style={{ fontSize: '18px', color: '#FF5722' }}>
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.ambition.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default AmbitionQuestionsPage;
