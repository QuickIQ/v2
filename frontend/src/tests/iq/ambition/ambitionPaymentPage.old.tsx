...
import { Lock, Shield, CheckCircle, Star, ArrowDown, TrendingUp } from 'lucide-react';
...
function RecentResults({ t, i18n, isMobile }: { t: any; i18n: any; isMobile: boolean }) {
  ...
  return (
    <section style={{
      ...
      >
        {getTranslation('tests.ambition.payment.recent_results', i18n.language === 'tr' ? 'Güncel Sonuçlar' : 'Recent Results')}
      </motion.h2>
      <div style={{
        maxWidth: '800px',
        margin: '0 auto',
...
export default function AmbitionPaymentPage() {
  ...
  const { resultLevel, resultData } = useAmbitionTestStore();
    ...
    <main style={{
      ...
      <div style={{
        ...
        {/* The Growing Mind Section - Always Visible */}
          <motion.div
            ...
            style={{
              ...
              backdropFilter: 'blur(20px)',
              borderRadius: '32px',
            boxShadow: '0 24px 80px rgba(255, 87, 34, 0.2), 0 0 0 1px rgba(255, 87, 34, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.8)',
          ...
          >
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                margin: 0,
                marginBottom: '8px',
                textShadow: '0 2px 8px rgba(255, 87, 34, 0.3)',
              }}>
                Your Detailed Ambition Result
              </h2>
          ...
          >
            ...
            <motion.div 
              ...
              style={{
                ...
                textAlign: 'center',
                marginTop: '32px',
                boxShadow: '0 4px 25px rgba(255, 87, 34, 0.08)',
                position: 'relative',
                transition: 'all 0.3s ease',
              }}
            >
              ...
              <p style={{
                ...
                {getTranslation('tests.ambition.payment.locked_subtext', 'Your personalized insight is waiting — Discover your hidden strengths, creative growth zones, and unique thinking blueprint.')}
              </p>
              <motion.button
                onClick={() => {
                  const paymentSection = document.getElementById('payment-section');
              ...
              >
                🔓 {getTranslation('tests.ambition.payment.unlock_button', 'Unlock Detailed Result')}
              </motion.button>
            </motion.div>
          </motion.div>
        ) : null}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.ambition.payment.why_trust', i18n.language === 'tr' ? 'Neden QuickIQ\'ya Güvenmelisiniz?' : 'Why Trust QuickIQ?')}
          </h2>
          ...
          <div style={{
            ...
            {[
              {
                icon: <Shield size={32} />,
                title: getTranslation('tests.ambition.payment.trust_feature1_title', i18n.language === 'tr' ? 'Yapay Zeka Destekli Yaratıcılık Analizi' : 'AI-Powered Creativity Analysis'),
                desc: getTranslation('tests.ambition.payment.trust_feature1_desc', i18n.language === 'tr' ? 'Gelişmiş algoritmalarla yaratıcı düşünme tarzınızın derinlemesine analizi.' : 'Deep analysis of your creative thinking style with advanced algorithms.'),
              },
              {
                icon: <CheckCircle size={32} />,
                title: getTranslation('tests.ambition.payment.trust_feature2_title', i18n.language === 'tr' ? 'Uygulanabilir İçgörüler' : 'Actionable Insights'),
                desc: getTranslation('tests.ambition.payment.trust_feature2_desc', i18n.language === 'tr' ? 'Gerçek hayatta kullanabileceğiniz pratik tavsiyeler.' : 'Practical advice you can use in real life.'),
              },
              {
                icon: <Lock size={32} />,
                title: getTranslation('tests.ambition.payment.trust_feature3_title', i18n.language === 'tr' ? 'Kişiselleştirilmiş Gelişim Planı' : 'Personalized Growth Plan'),
                desc: getTranslation('tests.ambition.payment.trust_feature3_desc', i18n.language === 'tr' ? 'Size özel hazırlanmış kapsamlı gelişim stratejisi.' : 'Comprehensive growth strategy tailored just for you.'),
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.ambition.payment.reviews', i18n.language === 'tr' ? 'Yorumlar' : 'Reviews')}
          </h2>
          <p style={{
            ...
            {getTranslation('tests.ambition.payment.reviews_subtitle', i18n.language === 'tr' ? 'Mükemmel ⭐ 4.7 puan — 1769 yorum' : 'Excellent ⭐ 4.7 rating — 1769 reviews')}
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    <p style={{
                      ...
                      {getTranslation('tests.ambition.payment.verified_customer', i18n.language === 'tr' ? 'Doğrulanmış Müşteri' : 'Verified Customer')}
                    </p>
                    <p style={{
                      fontSize: '14px',
                      color: '#666',
      ...
      >
        <p style={{
          ...
          {getTranslation('tests.ambition.payment.footer', i18n.language === 'tr'
