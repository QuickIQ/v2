...
function AmbitionAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.ambition.calculating.title', 'Analyzing your ambition patterns and drive balance...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.ambition.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
...
export default AmbitionAnalyzingPage;
