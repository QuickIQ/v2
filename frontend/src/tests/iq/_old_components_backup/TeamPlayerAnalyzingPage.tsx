...
function TeamPlayerAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.teamPlayer.calculating.title', 'Analyzing your team player role and collaboration style...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.teamPlayer.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
...
export default TeamPlayerAnalyzingPage;
