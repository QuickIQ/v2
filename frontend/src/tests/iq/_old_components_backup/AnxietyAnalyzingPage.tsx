...
function AnxietyAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.anxiety.calculating.title', 'Analyzing your anxiety patterns and stress management...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.anxiety.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Kaygılı düşünceler sizi rahatsız ediyor mu?'
                      : 'Do anxious thoughts disturb you?')
                  : (i18n.language === 'tr'
                      ? 'Stresli durumlarda kendinizi kontrol edebiliyor musunuz?'
                      : 'Can you control yourself in stressful situations?')}
              </p>
...
export default AnxietyAnalyzingPage;
