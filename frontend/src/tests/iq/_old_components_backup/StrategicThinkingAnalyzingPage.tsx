...
function StrategicThinkingAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.strategicThinking.calculating.title', 'Analyzing your strategic thinking patterns and decision-making approach...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.strategicThinking.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
...
export default StrategicThinkingAnalyzingPage;
