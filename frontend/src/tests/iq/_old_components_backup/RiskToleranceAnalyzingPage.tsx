...
function RiskToleranceAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: '0 20px 60px rgba(255, 68, 68, 0.15)',
      }}>
        {/* Title */}
        <motion.h1
        ...
        >
          {getTranslation('tests.riskTolerance.calculating.title', 'Analyzing your risk tolerance and decision-making patterns...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.riskTolerance.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Belirsizlik sizi heyecanlandırıyor mu?'
                      : 'Does uncertainty excite you?')
                  : (i18n.language === 'tr'
                      ? 'Riskli kararlar almakta rahat mısınız?'
                      : 'Are you comfortable making risky decisions?')}
              </p>
...
export default RiskToleranceAnalyzingPage;
