...
function TimeManagementAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <motion.div
        animate={{
          background: [
            'linear-gradient(135deg, #E0F7FA 0%, #E0F2F1 100%)',
            'linear-gradient(135deg, #E0F2F1 0%, #E0F7FA 100%)',
            'linear-gradient(135deg, #E0F7FA 0%, #E0F2F1 100%)',
          ],
        }}
        transition={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.timeManagement.calculating.title', 'Analyzing your time management patterns and efficiency...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.timeManagement.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Günlük görevlerinizi önceliklendiriyor musunuz?'
                      : 'Do you prioritize your daily tasks?')
                  : (i18n.language === 'tr'
                      ? 'Zamanınızı etkili bir şekilde planlıyor musunuz?'
...
export default TimeManagementAnalyzingPage;
