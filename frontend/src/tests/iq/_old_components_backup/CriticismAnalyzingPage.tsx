...
function CriticismAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.criticism.calculating.title', 'Analyzing your criticism response patterns and growth mindset...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.criticism.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
...
export default CriticismAnalyzingPage;
