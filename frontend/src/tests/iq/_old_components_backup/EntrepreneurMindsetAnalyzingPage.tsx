...
function EntrepreneurMindsetAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.entrepreneurMindset.calculating.title', 'Analyzing your entrepreneurial mindset and opportunity recognition...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.entrepreneurMindset.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Yeni iş fırsatlarını aktif olarak arıyor musunuz?'
                      : 'Do you actively seek out new business opportunities?')
                  : (i18n.language === 'tr'
                      ? 'Risk almak konusunda rahat mısınız?'
...
export default EntrepreneurMindsetAnalyzingPage;
