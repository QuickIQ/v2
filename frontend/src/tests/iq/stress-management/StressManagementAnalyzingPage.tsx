...
function StressManagementAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.stressManagement.calculating.title', 'Analyzing your stress management patterns and resilience...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.stressManagement.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
...
export default StressManagementAnalyzingPage;
