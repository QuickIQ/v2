...
function RecentResults({ t, i18n, isMobile }: { t: any; i18n: any; isMobile: boolean }) {
  ...
  return (
    <section style={{
      ...
      >
        {getTranslation('tests.memoryRetention.payment.recent_results', i18n.language === 'tr' ? 'Güncel Sonuçlar' : 'Recent Results')}
      </motion.h2>
      <div style={{
        maxWidth: '800px',
        margin: '0 auto',
...
export default function MemoryRetentionPaymentPage() {
  ...
  const { resultLevel, resultData } = useMemoryRetentionTestStore();
  ...
  const handleCardSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/test/memory-retention/unlock');
    } catch (error) {
      setProcessing(false);
  ...
  const getPlaceholderInsights = () => [
    'Understanding Your Patterns: Discover how your mind retains and recalls information',
    'Memory Awareness: Learn to recognize and enhance your memory retention abilities',
    'Recall Strategies: Explore techniques to improve your memory recall',
    'Growth Strategies: Practical steps to enhance your memory retention',
    'Future Potential: Unlock your path to improved memory and learning',
    'Memory Essentials: Build daily habits that support your cognitive retention'
  ];
    ...
    <main style={{
      ...
      <div style={{
          ...
          >
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                Your Detailed Memory Retention Result
              </h2>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {getTranslation('tests.memoryRetention.payment.locked_subtext', 'Your personalized insight is waiting — Discover your memory patterns, retention strengths, and recall blueprint.')}
              </p>
              <motion.button
                onClick={() => {
                  const paymentSection = document.getElementById('payment-section');
              ...
              >
                🔓 {getTranslation('tests.memoryRetention.payment.unlock_button', 'Unlock Detailed Result')}
              </motion.button>
            </motion.div>
          </motion.div>
        ) : null}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.memoryRetention.payment.why_trust', i18n.language === 'tr' ? 'Neden QuickIQ\'ya Güvenmelisiniz?' : 'Why Trust QuickIQ?')}
          </h2>
          ...
          <div style={{
            ...
            {[
              {
                icon: <Shield size={32} />,
                title: getTranslation('tests.memoryRetention.payment.trust_feature1_title', i18n.language === 'tr' ? 'Yapay Zeka Destekli Hafıza Analizi' : 'AI-Powered Memory Analysis'),
                desc: getTranslation('tests.memoryRetention.payment.trust_feature1_desc', i18n.language === 'tr' ? 'Gelişmiş algoritmalarla hafıza tutma ve hatırlama kalıplarınızın derinlemesine analizi.' : 'Deep analysis of your memory retention and recall patterns with advanced algorithms.'),
              },
              {
                icon: <CheckCircle size={32} />,
                title: getTranslation('tests.memoryRetention.payment.trust_feature2_title', i18n.language === 'tr' ? 'Uygulanabilir İçgörüler' : 'Actionable Insights'),
                desc: getTranslation('tests.memoryRetention.payment.trust_feature2_desc', i18n.language === 'tr' ? 'Gerçek hayatta kullanabileceğiniz pratik tavsiyeler.' : 'Practical advice you can use in real life.'),
              },
              {
                icon: <Lock size={32} />,
                title: getTranslation('tests.memoryRetention.payment.trust_feature3_title', i18n.language === 'tr' ? 'Kişiselleştirilmiş Gelişim Planı' : 'Personalized Growth Plan'),
                desc: getTranslation('tests.memoryRetention.payment.trust_feature3_desc', i18n.language === 'tr' ? 'Size özel hazırlanmış kapsamlı gelişim stratejisi.' : 'Comprehensive growth strategy tailored just for you.'),
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.memoryRetention.payment.reviews', i18n.language === 'tr' ? 'Yorumlar' : 'Reviews')}
          </h2>
          <p style={{
            ...
            {getTranslation('tests.memoryRetention.payment.reviews_subtitle', i18n.language === 'tr' ? 'Mükemmel ⭐ 4.7 puan — 1769 yorum' : 'Excellent ⭐ 4.7 rating — 1769 reviews')}
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    <p style={{
                      ...
                      {getTranslation('tests.memoryRetention.payment.verified_customer', i18n.language === 'tr' ? 'Doğrulanmış Müşteri' : 'Verified Customer')}
                    </p>
                    <p style={{
                      fontSize: '14px',
                      color: '#666',
      ...
      >
        <p style={{
          ...
          {getTranslation('tests.memoryRetention.payment.footer', i18n.language === 'tr'
