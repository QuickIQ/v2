...
interface MemoryRetentionUnlockTemplateProps {
  level: 'excellent' | 'good' | 'developing';
  locale?: 'en' | 'tr';
}

export default function MemoryRetentionUnlockTemplate({ level, locale }: MemoryRetentionUnlockTemplateProps) {
  ...
  const getContent = () => {
    const baseKey = `tests.memoryRetention.result.${level}`;
    return {
  ...
  const sections = [
    {
      ...
      title: currentLocale === 'tr' ? 'Hafıza Tutma Profiliniz' : 'Your Memory Retention Profile',
    ...
    },
    {
      ...
      text: currentLocale === 'tr' 
        ? 'Hafıza tutma kalıplarınız ve hatırlama yetenekleriniz hakkında en önemli bulgular:'
        : 'The most important findings about your memory retention patterns and recall abilities:',
    ...
    },
    {
      ...
      text: content.sections?.strengths || (level === 'excellent'
        ? (currentLocale === 'tr' 
          ? 'Hafıza tutma konusunda olağanüstü yeteneklere sahipsiniz. İşte en güçlü yönleriniz:'
          : 'You possess exceptional memory retention abilities. Here are your strongest areas:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Hafıza tutma konusunda güçlü yetenekleriniz var. İşte öne çıkan güçlü yönleriniz:'
          : 'You have strong memory retention skills. Here are your standout strengths:')
        : (currentLocale === 'tr'
          ? 'Hafıza tutma potansiyeliniz gelişiyor. İşte güçlü yönleriniz:'
          : 'Your memory retention potential is developing. Here are your strengths:')),
    },
    {
      key: 'growth',
      ...
      text: content.sections?.growthAreas || (level === 'excellent'
        ? (currentLocale === 'tr'
          ? 'Mükemmel seviyede olsanız bile, hafıza tutmanızı daha da geliştirebileceğiniz alanlar:'
          : 'Even at an excellent level, areas where you can further enhance your memory retention:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Hafıza tutmanızı daha da artırmak için odaklanabileceğiniz alanlar:'
          : 'Areas you can focus on to further increase your memory retention:')
        : (currentLocale === 'tr'
          ? 'Hafıza tutmanızı geliştirmek için pratik yapabileceğiniz alanlar:'
          : 'Areas you can practice to develop your memory retention abilities:')),
    },
    {
      key: 'application',
      ...
      text: content.sections?.practicalApplications || (currentLocale === 'tr'
        ? 'Hafıza tutmanızı günlük hayatta nasıl koruyabileceğiniz:'
        : 'How you can maintain your memory retention in daily life:'),
    },
    {
      key: 'future',
      ...
      text: content.sections?.futurePotential || (currentLocale === 'tr'
        ? 'Hafıza tutmanızı geliştirmeye devam ederseniz neler başarabileceğiniz:'
        : 'What you can achieve if you continue developing your memory retention:'),
    },
  ];
      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <motion.div
              ...
              transition={{ 
                ...
                filter: 'drop-shadow(0 2px 8px rgba(156, 39, 176, 0.4))',
                }}
              >
              🧠
            </motion.div>
          ...
          <h1 style={{
            ...
            Your Detailed Memory Retention Report
          </h1>
          <p style={{
