...
function MemoryRetentionAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.memoryRetention.calculating.title', 'Analyzing your memory retention patterns and recall abilities...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.memoryRetention.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Bilgileri hatırlamakta zorlanıyor musunuz?'
                      : 'Do you struggle to remember information?')
                  : (i18n.language === 'tr'
                      ? 'Öğrendiklerinizi uzun süre hatırlayabiliyor musunuz?'
                      : 'Can you remember what you learned for a long time?')}
              </p>
...
export default MemoryRetentionAnalyzingPage;
