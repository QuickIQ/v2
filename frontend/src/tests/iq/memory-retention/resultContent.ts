...
export const resultContent: Record<'excellent' | 'good' | 'developing', MemoryRetentionResult> = {
  excellent: {
    level: 'excellent',
    title: '', // Will be filled via localization: tests.memoryRetention.result.excellent.title
    summary: '', // Will be filled via localization: tests.memoryRetention.result.excellent.summary
    insights: [], // Will be filled via localization: tests.memoryRetention.result.excellent.insights
    sections: {
      strengths: '', // Will be filled via localization: tests.memoryRetention.result.excellent.strengths.text
      growthAreas: '', // Will be filled via localization: tests.memoryRetention.result.excellent.growthAreas.text
      practicalApplications: '', // Will be filled via localization: tests.memoryRetention.result.excellent.practicalApplications.text
      futurePotential: '', // Will be filled via localization: tests.memoryRetention.result.excellent.futurePotential.text
    }
  },
  good: {
    level: 'good',
