...
import { useTeamPlayerTestStore, TeamPlayerQuestion, TeamPlayerAnswer } from '../../../store/teamPlayerTestStore';
...
function TeamPlayerQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useTeamPlayerTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useTeamPlayerTestStore.getState().timeRemaining;
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.teamPlayer.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default TeamPlayerQuestionsPage;
