...
interface RiskToleranceUnlockTemplateProps {
  level: 'excellent' | 'good' | 'developing';
  locale?: 'en' | 'tr';
}

export default function RiskToleranceUnlockTemplate({ level, locale }: RiskToleranceUnlockTemplateProps) {
  ...
  const getContent = () => {
    const baseKey = `tests.riskTolerance.result.${level}`;
    return {
  ...
  const sections = [
    {
      ...
      title: currentLocale === 'tr' ? 'Risk Toleransı Profiliniz' : 'Your Risk Tolerance Profile',
    ...
    },
    {
      ...
      text: currentLocale === 'tr' 
        ? 'Risk toleransınız ve karar verme kalıplarınız hakkında en önemli bulgular:'
        : 'The most important findings about your risk tolerance and decision-making patterns:',
    ...
    },
    {
      ...
      text: content.sections?.strengths || (level === 'excellent'
        ? (currentLocale === 'tr' 
          ? 'Risk toleransınız konusunda olağanüstü yeteneklere sahipsiniz. İşte en güçlü yönleriniz:'
          : 'You possess exceptional risk tolerance abilities. Here are your strongest areas:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Risk toleransınız konusunda güçlü yetenekleriniz var. İşte öne çıkan güçlü yönleriniz:'
          : 'You have strong risk tolerance skills. Here are your standout strengths:')
        : (currentLocale === 'tr'
          ? 'Risk toleransınız potansiyeliniz gelişiyor. İşte güçlü yönleriniz:'
          : 'Your risk tolerance potential is developing. Here are your strengths:')),
    },
    {
      key: 'growth',
      ...
      text: content.sections?.growthAreas || (level === 'excellent'
        ? (currentLocale === 'tr'
          ? 'Mükemmel seviyede olsanız bile, risk toleransınızı daha da geliştirebileceğiniz alanlar:'
          : 'Even at an excellent level, areas where you can further enhance your risk tolerance:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Risk toleransınızı daha da artırmak için odaklanabileceğiniz alanlar:'
          : 'Areas you can focus on to further increase your risk tolerance:')
        : (currentLocale === 'tr'
          ? 'Risk toleransınızı geliştirmek için pratik yapabileceğiniz alanlar:'
          : 'Areas you can practice to develop your risk tolerance abilities:')),
    },
    {
      key: 'application',
      ...
      text: content.sections?.practicalApplications || (currentLocale === 'tr'
        ? 'Risk toleransınızı günlük hayatta nasıl kullanabileceğiniz:'
        : 'How you can use your risk tolerance in daily life:'),
    },
    {
      key: 'future',
      ...
      text: content.sections?.futurePotential || (currentLocale === 'tr'
        ? 'Risk toleransınızı geliştirmeye devam ederseniz neler başarabileceğiniz:'
        : 'What you can achieve if you continue developing your risk tolerance:'),
    },
  ];
  ...
  return (
    <main style={{
      minHeight: '100vh',
      background: 'radial-gradient(ellipse at top, #FFE8E8 0%, #FFF0F0 50%, #FFF5F5 100%)',
      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <motion.div
              ...
              transition={{ 
                ...
                filter: 'drop-shadow(0 2px 8px rgba(255, 68, 68, 0.4))',
                }}
              >
              📈
            </motion.div>
          ...
          <h1 style={{
            ...
            Your Detailed Risk Tolerance Report
          </h1>
          <p style={{
