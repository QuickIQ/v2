...
import { useSuccessTestStore, SuccessQuestion, SuccessAnswer } from '../../../store/successTestStore';
import { useMobile } from '../../../hooks/useMobile';
import { Clock, Trophy } from 'lucide-react';
import '../../../App.css';

interface Props {
  questions: SuccessQuestion[];
  onComplete: () => void;
}
...
function SuccessQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useSuccessTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useSuccessTestStore.getState().timeRemaining;
  ...
  if (!currentQuestion) {
    return (
      <div style={{
        ...
        <div className="loading" style={{ fontSize: '18px', color: '#FFC107' }}>
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.success.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default SuccessQuestionsPage;
