...
function SuccessAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.success.calculating.title', 'Analyzing your success mindset and achievement patterns...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.success.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
...
export default SuccessAnalyzingPage;
