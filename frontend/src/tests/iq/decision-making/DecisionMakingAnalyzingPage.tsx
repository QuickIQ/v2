...
function DecisionMakingAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <motion.div
        animate={{
          background: [
            'linear-gradient(135deg, #E8F0FF 0%, #F0E8FF 100%)',
            'linear-gradient(135deg, #F0E8FF 0%, #E8F0FF 100%)',
            'linear-gradient(135deg, #E8F0FF 0%, #F0E8FF 100%)',
          ],
        }}
        transition={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.decisionMaking.calculating.title', 'Analyzing your decision-making style and approach...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.decisionMaking.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Kararlarınızı verirken mantığa mı yoksa sezgilere mi güveniyorsunuz?'
                      : 'Do you rely on logic or intuition when making decisions?')
                  : (i18n.language === 'tr'
                      ? 'Önemli kararlar alırken veri ve analiz mi yoksa içgüdüleriniz mi önceliklidir?'
                      : 'When making important decisions, do you prioritize data and analysis or your instincts?')}
              </p>
...
export default DecisionMakingAnalyzingPage;
