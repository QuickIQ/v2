...
import { useDecisionMakingTestStore, DecisionMakingQuestion, DecisionMakingAnswer } from '../../../store/decisionMakingTestStore';
...
function DecisionMakingQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useDecisionMakingTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useDecisionMakingTestStore.getState().timeRemaining;
  ...
  const handleOptionSelect = (optionIndex: number) => {
    ...
    const answer: DecisionMakingAnswer = {
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.decisionMaking.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default DecisionMakingQuestionsPage;
