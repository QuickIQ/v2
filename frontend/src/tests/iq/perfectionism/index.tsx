...
function PerfectionismIntro({ onStart }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.perfectionism.landing.title', 'Before You Begin')}
          <motion.div
            animate={{
              scale: [1, 1.2, 1],
              opacity: [0.7, 1, 0.7],
        ...
        >
          {getTranslation('tests.perfectionism.landing.subtitle', 'Answer honestly — this test is for your self-discovery, not for judgment.')}
        </motion.p>
        ...
        >
          <p style={{
            ...
            {getTranslation('tests.perfectionism.landing.description', 'Be as genuine as possible. Your responses are not stored or shared — they\'re only used to calculate your result.')}
          </p>
          <p style={{
            ...
            {getTranslation('tests.perfectionism.landing.reminder', 'You\'ll have 10 minutes to answer 20 questions. Take a deep breath and focus — this is your moment of reflection.')}
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: isMobile ? '14px' : '16px', color: '#666', fontWeight: '500' }}>
              {getTranslation('tests.perfectionism.landing.questions', 'Questions')}
            </div>
          </motion.div>
          <motion.div
            whileHover={{ scale: 1.05, y: -5 }}
          ...
          >
            ...
            <div style={{ fontSize: isMobile ? '14px' : '16px', color: '#666', fontWeight: '500' }}>
              {getTranslation('tests.perfectionism.landing.minutes', 'Minutes')}
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            />
            {getTranslation('tests.perfectionism.landing.startButton', 'Continue')}
          </motion.button>
        </motion.div>
      </div>
    </div>
...
export default PerfectionismIntro;
