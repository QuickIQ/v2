...
import { useStrategicThinkingTestStore, StrategicThinkingQuestion, StrategicThinkingAnswer } from '../../../store/strategicThinkingTestStore';
import { useMobile } from '../../../hooks/useMobile';
import { Clock } from 'lucide-react';
import '../../../App.css';

interface Props {
  questions: StrategicThinkingQuestion[];
  onComplete: () => void;
}
...
function StrategicThinkingQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useStrategicThinkingTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useStrategicThinkingTestStore.getState().timeRemaining;
  ...
  const handleOptionSelect = (optionIndex: number) => {
    ...
    const answer: StrategicThinkingAnswer = {
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.strategicThinking.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    background: !currentAnswer || autoAdvancing
                      ...
                      : 'linear-gradient(135deg, #4A6CFF 0%, #6B8EFF 100%)',
                    border: 'none',
                    borderRadius: '12px',
...
export default StrategicThinkingQuestionsPage;
