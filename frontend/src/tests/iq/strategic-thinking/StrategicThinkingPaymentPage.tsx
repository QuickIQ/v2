...
function RecentResults({ t, i18n, isMobile }: { t: any; i18n: any; isMobile: boolean }) {
  ...
  return (
    <section style={{
      ...
      >
        {getTranslation('tests.strategicThinking.payment.recent_results', i18n.language === 'tr' ? 'Güncel Sonuçlar' : 'Recent Results')}
      </motion.h2>
      <div style={{
        maxWidth: '800px',
        margin: '0 auto',
...
export default function StrategicThinkingPaymentPage() {
  ...
  const { resultLevel, resultData } = useStrategicThinkingTestStore();
  ...
  const handleCardSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/test/strategic-thinking/unlock');
    } catch (error) {
      setProcessing(false);
  ...
  const getResultTitle = () => {
    ...
    if (resultLevel === 'excellent') return 'Strategic Thinker – The Visionary Strategist';
    if (resultLevel === 'good') return 'Strategic Thinker – The Adaptive Planner';
    return 'Strategic Thinker – The Emerging Strategist';
  };

  const getResultEmojis = () => {
    if (resultLevel === 'excellent') return ['🧭', '✨', '🎯'];
    if (resultLevel === 'good') return ['🗺️', '🌟', '💫'];
    return ['🧭', '🗺️', '🎯'];
  };

  // Placeholder insights that always show
  const getPlaceholderInsights = () => [
    'Long-Term Vision: Discover how you see and plan for the future',
    'Pattern Recognition: Learn how you identify trends and connections',
    'Decision-Making Style: Explore your approach to complex choices',
    'Strategic Planning: Practical steps to enhance your planning skills',
    'Future Potential: Unlock your path to becoming a strategic leader',
    'Critical Thinking: Build habits that strengthen your analytical abilities'
  ];
    ...
    <main style={{
      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            ...
            >
              Your Strategic Mind Awaits Discovery
              <motion.div
                animate={{
                  scale: [1, 1.2, 1],
                  opacity: [0.7, 1, 0.7],
            ...
            >
              Unlock your strategic thinking potential — AI has analyzed your answers and crafted a detailed insight just for you.
            </motion.p>
        ...
        {/* The Growing Mind Section - Always Visible */}
          <motion.div
            ...
            style={{
              ...
              backdropFilter: 'blur(20px)',
              borderRadius: '32px',
            boxShadow: '0 24px 80px rgba(74, 108, 255, 0.2), 0 0 0 1px rgba(74, 108, 255, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.8)',
          ...
          >
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                fontWeight: '700',
                background: 'linear-gradient(135deg, #4A6CFF 0%, #6B8EFF 50%, #4A6CFF 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
                margin: 0,
                marginBottom: '8px',
                textShadow: '0 2px 8px rgba(74, 108, 255, 0.3)',
              }}>
                Your Strategic Thinking Journey
              </h2>
              ...
              <div style={{
                ...
                <span style={{
                  flex: 1,
                  height: '2px',
                  background: 'linear-gradient(90deg, transparent, #4A6CFF, transparent)',
                  maxWidth: '150px',
                }} />
                <motion.span
                  animate={{
                  ...
                  <div style={{
                    ...
                    return (
                      <motion.div
                        ...
                        whileHover={{
                          scale: 1.06,
                            boxShadow: '0 0 25px rgba(74, 108, 255,0.4)',
                            background: 'linear-gradient(135deg, #E3E8F5 0%, #E8F0FE 100%)',
                        ...
                        style={{
                          ...
                          minHeight: isTablet ? '170px' : '180px',
                            background: 'linear-gradient(135deg, #E8F0FE 0%, #F0F4FF 100%)',
                          borderRadius: '16px',
                            border: '1.5px solid rgba(74, 108, 255,0.15)',
                            boxShadow: '0 2px 10px rgba(74, 108, 255,0.1)',
                          padding: '18px 20px',
                          cursor: 'pointer',
                          textAlign: 'center',
                          display: 'flex',
              ...
              <motion.div
                ...
                style={{
                  ...
                  border: '2px solid rgba(74, 108, 255, 0.2)',
                  boxShadow: '0 8px 32px rgba(74, 108, 255, 0.15)',
                  textAlign: 'center',
                }}
              >
                <p style={{
        ...
        {resultLevel && resultData ? (
          ...
          >
            ...
            <motion.div 
              ...
              whileHover={{
                scale: 1.02,
                boxShadow: '0 0 40px rgba(74, 108, 255, 0.25)',
                transition: { duration: 0.3 }
              }}
              style={{
                ...
                borderRadius: '22px',
                border: '2px dashed rgba(74, 108, 255, 0.25)',
                textAlign: 'center',
                marginTop: '32px',
                boxShadow: '0 4px 25px rgba(74, 108, 255, 0.08)',
                position: 'relative',
                transition: 'all 0.3s ease',
              }}
            >
              ...
              <p style={{
                ...
                {getTranslation('tests.strategicThinking.payment.locked_subtext', 'Your personalized insight is waiting — Discover your hidden strengths, creative growth zones, and unique thinking blueprint.')}
              </p>
              <motion.button
                onClick={() => {
                  const paymentSection = document.getElementById('payment-section');
              ...
              >
                🔓 {getTranslation('tests.strategicThinking.payment.unlock_button', 'Unlock Detailed Result')}
              </motion.button>
            </motion.div>
          </motion.div>
        ) : null}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.strategicThinking.payment.why_trust', i18n.language === 'tr' ? 'Neden QuickIQ\'ya Güvenmelisiniz?' : 'Why Trust QuickIQ?')}
          </h2>
          ...
          <div style={{
            ...
            {[
              {
                icon: <Shield size={32} />,
                title: getTranslation('tests.strategicThinking.payment.trust_feature1_title', i18n.language === 'tr' ? 'Yapay Zeka Destekli Yaratıcılık Analizi' : 'AI-Powered Creativity Analysis'),
                desc: getTranslation('tests.strategicThinking.payment.trust_feature1_desc', i18n.language === 'tr' ? 'Gelişmiş algoritmalarla yaratıcı düşünme tarzınızın derinlemesine analizi.' : 'Deep analysis of your creative thinking style with advanced algorithms.'),
              },
              {
                icon: <CheckCircle size={32} />,
                title: getTranslation('tests.strategicThinking.payment.trust_feature2_title', i18n.language === 'tr' ? 'Uygulanabilir İçgörüler' : 'Actionable Insights'),
                desc: getTranslation('tests.strategicThinking.payment.trust_feature2_desc', i18n.language === 'tr' ? 'Gerçek hayatta kullanabileceğiniz pratik tavsiyeler.' : 'Practical advice you can use in real life.'),
              },
              {
                icon: <Lock size={32} />,
                title: getTranslation('tests.strategicThinking.payment.trust_feature3_title', i18n.language === 'tr' ? 'Kişiselleştirilmiş Gelişim Planı' : 'Personalized Growth Plan'),
                desc: getTranslation('tests.strategicThinking.payment.trust_feature3_desc', i18n.language === 'tr' ? 'Size özel hazırlanmış kapsamlı gelişim stratejisi.' : 'Comprehensive growth strategy tailored just for you.'),
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.strategicThinking.payment.reviews', i18n.language === 'tr' ? 'Yorumlar' : 'Reviews')}
          </h2>
          <p style={{
            ...
            {getTranslation('tests.strategicThinking.payment.reviews_subtitle', i18n.language === 'tr' ? 'Mükemmel ⭐ 4.7 puan — 1769 yorum' : 'Excellent ⭐ 4.7 rating — 1769 reviews')}
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    <p style={{
                      ...
                      {getTranslation('tests.strategicThinking.payment.verified_customer', i18n.language === 'tr' ? 'Doğrulanmış Müşteri' : 'Verified Customer')}
                    </p>
                    <p style={{
                      fontSize: '14px',
                      color: '#666',
      ...
      >
        <p style={{
          ...
          {getTranslation('tests.strategicThinking.payment.footer', i18n.language === 'tr'
