...
import { useDisorderTestStore, DisorderQuestion, DisorderAnswer } from '../../../store/disorderTestStore';
...
function DisorderQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useDisorderTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useDisorderTestStore.getState().timeRemaining;
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.disorder.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default DisorderQuestionsPage;
