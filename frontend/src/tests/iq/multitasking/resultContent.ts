export interface MultitaskingResult {
...
export const resultContent: Record<'excellent' | 'good' | 'developing', MultitaskingResult> = {
  excellent: {
    level: 'excellent',
    title: '', // Will be filled via localization: tests.multitasking.result.excellent.title
