...
function MultitaskingAnalyzingPage({ onComplete }: Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        >
          {getTranslation('tests.multitasking.calculating.title', 'Analyzing your multitasking efficiency and task management patterns...')}
        </motion.h1>
        ...
        >
          {getTranslation('tests.multitasking.calculating.subtitle', 'Our AI is evaluating your responses. This will take a few seconds...')}
        </motion.p>
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {popupStep === 35
                  ? (i18n.language === 'tr'
                      ? 'Aynı anda birden fazla işi yönetmekte zorlanıyor musunuz?'
                      : 'Do you struggle to manage multiple tasks at the same time?')
                  : (i18n.language === 'tr'
                      ? 'Çoklu görevler arasında geçiş yaparken odak kaybediyor musunuz?'
                      : 'Do you lose focus when switching between multiple tasks?')}
              </p>
...
export default MultitaskingAnalyzingPage;
