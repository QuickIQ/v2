...
function RecentResults({ t, i18n, isMobile }: { t: any; i18n: any; isMobile: boolean }) {
  ...
  return (
    <section style={{
      ...
      >
        {getTranslation('tests.anxiety.payment.recent_results', i18n.language === 'tr' ? 'Güncel Sonuçlar' : 'Recent Results')}
      </motion.h2>
      <div style={{
        maxWidth: '800px',
        margin: '0 auto',
...
export default function AnxietyPaymentPage() {
  ...
  const { resultLevel, resultData } = useAnxietyTestStore();
  ...
  const getPlaceholderInsights = () => [
    'Understanding Your Patterns: Discover how your mind processes anxiety and stress',
    'Anxiety Awareness: Learn to recognize and manage your anxious responses',
    'Stress Management: Explore techniques to control anxiety and maintain calm',
    'Growth Strategies: Practical steps to improve your anxiety management',
    'Future Potential: Unlock your path to emotional control and peace',
    'Self-Care Essentials: Build daily habits that support your mental calm'
  ];
    ...
    <main style={{
      ...
      <div style={{
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {getTranslation('tests.anxiety.payment.locked_subtext', 'Your personalized insight is waiting — Discover your anxiety patterns, stress management strengths, and emotional control blueprint.')}
              </p>
              <motion.button
                onClick={() => {
                  const paymentSection = document.getElementById('payment-section');
              ...
              >
                🔓 {getTranslation('tests.anxiety.payment.unlock_button', 'Unlock Detailed Result')}
              </motion.button>
            </motion.div>
          </motion.div>
        ) : null}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.anxiety.payment.why_trust', i18n.language === 'tr' ? 'Neden QuickIQ\'ya Güvenmelisiniz?' : 'Why Trust QuickIQ?')}
          </h2>
          ...
          <div style={{
            ...
            {[
              {
                icon: <Shield size={32} />,
                title: getTranslation('tests.anxiety.payment.trust_feature1_title', i18n.language === 'tr' ? 'Yapay Zeka Destekli Kaygı Analizi' : 'AI-Powered Anxiety Analysis'),
                desc: getTranslation('tests.anxiety.payment.trust_feature1_desc', i18n.language === 'tr' ? 'Gelişmiş algoritmalarla kaygı kalıplarınızın ve stres yönetimi yeteneklerinizin derinlemesine analizi.' : 'Deep analysis of your anxiety patterns and stress management abilities with advanced algorithms.'),
              },
              {
                icon: <CheckCircle size={32} />,
                title: getTranslation('tests.anxiety.payment.trust_feature2_title', i18n.language === 'tr' ? 'Uygulanabilir İçgörüler' : 'Actionable Insights'),
                desc: getTranslation('tests.anxiety.payment.trust_feature2_desc', i18n.language === 'tr' ? 'Gerçek hayatta kullanabileceğiniz pratik tavsiyeler.' : 'Practical advice you can use in real life.'),
              },
              {
                icon: <Lock size={32} />,
                title: getTranslation('tests.anxiety.payment.trust_feature3_title', i18n.language === 'tr' ? 'Kişiselleştirilmiş Gelişim Planı' : 'Personalized Growth Plan'),
                desc: getTranslation('tests.anxiety.payment.trust_feature3_desc', i18n.language === 'tr' ? 'Size özel hazırlanmış kapsamlı gelişim stratejisi.' : 'Comprehensive growth strategy tailored just for you.'),
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        >
          <h2 style={{
            ...
            {getTranslation('tests.anxiety.payment.reviews', i18n.language === 'tr' ? 'Yorumlar' : 'Reviews')}
          </h2>
          <p style={{
            ...
            {getTranslation('tests.anxiety.payment.reviews_subtitle', i18n.language === 'tr' ? 'Mükemmel ⭐ 4.7 puan — 1769 yorum' : 'Excellent ⭐ 4.7 rating — 1769 reviews')}
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    <p style={{
                      ...
                      {getTranslation('tests.anxiety.payment.verified_customer', i18n.language === 'tr' ? 'Doğrulanmış Müşteri' : 'Verified Customer')}
                    </p>
                    <p style={{
                      fontSize: '14px',
                      color: '#666',
      ...
      >
        <p style={{
          ...
          {getTranslation('tests.anxiety.payment.footer', i18n.language === 'tr'
