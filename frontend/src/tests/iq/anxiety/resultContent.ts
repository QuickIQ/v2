...
export const resultContent: Record<'excellent' | 'good' | 'developing', AnxietyResult> = {
  excellent: {
    level: 'excellent',
    title: '', // Will be filled via localization: tests.anxiety.result.excellent.title
    summary: '', // Will be filled via localization: tests.anxiety.result.excellent.summary
    insights: [], // Will be filled via localization: tests.anxiety.result.excellent.insights
    sections: {
      strengths: '', // Will be filled via localization: tests.anxiety.result.excellent.strengths.text
      growthAreas: '', // Will be filled via localization: tests.anxiety.result.excellent.growthAreas.text
      practicalApplications: '', // Will be filled via localization: tests.anxiety.result.excellent.practicalApplications.text
      futurePotential: '', // Will be filled via localization: tests.anxiety.result.excellent.futurePotential.text
    }
  },
  good: {
    level: 'good',
