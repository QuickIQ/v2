...
import { useAnxietyTestStore, AnxietyQuestion, AnxietyAnswer } from '../../../store/anxietyTestStore';
...
function AnxietyQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useAnxietyTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useAnxietyTestStore.getState().timeRemaining;
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.anxiety.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default AnxietyQuestionsPage;
