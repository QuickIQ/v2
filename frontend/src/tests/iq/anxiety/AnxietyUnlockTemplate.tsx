...
interface AnxietyUnlockTemplateProps {
  level: 'excellent' | 'good' | 'developing';
  locale?: 'en' | 'tr';
}

export default function AnxietyUnlockTemplate({ level, locale }: AnxietyUnlockTemplateProps) {
  ...
  const getContent = () => {
    const baseKey = `tests.anxiety.result.${level}`;
    return {
  ...
  const sections = [
    {
      ...
      title: currentLocale === 'tr' ? 'Kaygı Profiliniz' : 'Your Anxiety Profile',
    ...
    },
    {
      ...
      text: currentLocale === 'tr' 
        ? 'Kaygı kalıplarınız ve stres yönetimi hakkında en önemli bulgular:'
        : 'The most important findings about your anxiety patterns and stress management:',
    ...
    },
    {
      ...
      text: content.sections?.strengths || (level === 'excellent'
        ? (currentLocale === 'tr' 
          ? 'Kaygı yönetimi konusunda olağanüstü yeteneklere sahipsiniz. İşte en güçlü yönleriniz:'
          : 'You possess exceptional anxiety management abilities. Here are your strongest areas:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Kaygı yönetimi konusunda güçlü yetenekleriniz var. İşte öne çıkan güçlü yönleriniz:'
          : 'You have strong anxiety management skills. Here are your standout strengths:')
        : (currentLocale === 'tr'
          ? 'Kaygı yönetimi potansiyeliniz gelişiyor. İşte güçlü yönleriniz:'
          : 'Your anxiety management potential is developing. Here are your strengths:')),
    },
    {
      key: 'growth',
      ...
      text: content.sections?.growthAreas || (level === 'excellent'
        ? (currentLocale === 'tr'
          ? 'Mükemmel seviyede olsanız bile, kaygı yönetiminizi daha da geliştirebileceğiniz alanlar:'
          : 'Even at an excellent level, areas where you can further enhance your anxiety management:')
        : level === 'good'
        ? (currentLocale === 'tr'
          ? 'Kaygı yönetiminizi daha da artırmak için odaklanabileceğiniz alanlar:'
          : 'Areas you can focus on to further increase your anxiety management:')
        : (currentLocale === 'tr'
          ? 'Kaygı yönetiminizi geliştirmek için pratik yapabileceğiniz alanlar:'
          : 'Areas you can practice to develop your anxiety management abilities:')),
    },
    {
      key: 'application',
      ...
      text: content.sections?.practicalApplications || (currentLocale === 'tr'
        ? 'Kaygı yönetiminizi günlük hayatta nasıl koruyabileceğiniz:'
        : 'How you can maintain your anxiety management in daily life:'),
    },
    {
      key: 'future',
      ...
      text: content.sections?.futurePotential || (currentLocale === 'tr'
        ? 'Kaygı yönetiminizi geliştirmeye devam ederseniz neler başarabileceğiniz:'
        : 'What you can achieve if you continue developing your anxiety management:'),
    },
  ];
