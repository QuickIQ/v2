...
import { useCriticismTestStore, CriticismQuestion, CriticismAnswer } from '../../../store/criticismTestStore';
import { useMobile } from '../../../hooks/useMobile';
import { Clock, MessageSquare } from 'lucide-react';
import '../../../App.css';

interface Props {
  questions: CriticismQuestion[];
  onComplete: () => void;
}
...
function CriticismQuestionsPage({ questions, onComplete }: Props) {
  ...
  useEffect(() => {
    ...
    let currentTime = useCriticismTestStore.getState().timeRemaining;
    ...
    timerIntervalRef.current = setInterval(() => {
      const storeTime = useCriticismTestStore.getState().timeRemaining;
      ...
      <div style={{
        ...
        <div className="card" style={{
          ...
          <div style={{ color: '#e74c3c', marginBottom: '20px' }}>
            {t('tests.criticism.errors.load_questions') || 'Failed to load questions. Please try again.'}
          </div>
        </div>
      </div>
    );
...
export default CriticismQuestionsPage;
