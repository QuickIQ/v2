...
function RecentResults({ t, i18n, isMobile, testId }: { t: any; i18n: any; isMobile: boolean; testId: string }) {
...
export default function UniversalPaymentPage({ testId: testIdProp }: UniversalPaymentPageProps) {
  ...
  const { resultLevel, resultData } = useTestStore();
  ...
  return (
    <main style={{
      ...
      <div style={{
          ...
          >
            ...
            >
              ...
              <p style={{
                ...
                {getTranslation(`tests.${testId}.payment.locked_subtext`, 'Your personalized insight is waiting — Discover your hidden strengths, creative growth zones, and unique thinking blueprint.')}
              </p>
              <motion.button
                onClick={() => {
                  const paymentSection = document.getElementById('payment-section');
              ...
              >
                🔓 {getTranslation(`tests.${testId}.payment.unlock_button`, 'Unlock Detailed Result')}
              </motion.button>
            </motion.div>
          </motion.div>
        ) : null}
        ...
        <RecentResults t={t} i18n={i18n} isMobile={isMobile} testId={testId} />
