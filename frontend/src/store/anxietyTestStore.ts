...
export interface AnxietyTestState {
  // Session
  ...
  setQuestions: (questions: AnxietyQuestion[]) => void;
  setCurrentQuestionIndex: (index: number) => void;
  addAnswer: (answer: AnxietyAnswer) => void;
  calculateScore: () => void;
  setResultData: (data: any) => void;
  setEmail: (email: string) => void;
  setStep: (step: AnxietyTestState['step']) => void;
  reset: () => void;
}
...
export const useAnxietyTestStore = create<AnxietyTestState>()(
  persist(
    (set, get) => ({
      ...initialState,
      ...
      setQuestions: (questions: AnxietyQuestion[]) => set({ questions }),
      
      setCurrentQuestionIndex: (index: number) => set({ currentQuestionIndex: index }),
      
      addAnswer: (answer: AnxietyAnswer) => {
      ...
      setStep: (step: AnxietyTestState['step']) => set({ step }),
      
      reset: () => set(initialState),
    }),
    {
      name: 'anxiety-test-storage',
      partialize: (state) => ({
